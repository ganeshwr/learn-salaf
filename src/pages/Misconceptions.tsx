                      ...
                      <Card className="h-full hover:shadow-xl">
                        <div className="p-8 h-full flex flex-col justify-between">
                          ...
                          <div className="flex items-center text-primary-600">
                            ...
                            <span className="font-medium">Click to see the truth</span>
                          </div>
                        </div>
                      </Card>
                    </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Card>
            <div className="p-8">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Seek Knowledge with Wisdom
              </h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Always verify information from authentic sources and consult qualified scholars. 
                May Allah guide us all to the truth and away from misconceptions.
              </p>
